...
RSpec.describe Bishop do
  ...
  describe '#find_possible_moves' do
    ...
    context 'when there are 3 empty diagonal spaces increasing rank' do
      subject(:bbp) { described_class.new(board, { color: :black, location: [0, 2] }) }
      let(:data) do
        [
          [nil, nil, bbp, nil, nil, nil, nil, nil],
          [nil, nil, nil, nil, nil, nil, nil, nil],
      ...
      it 'has three moves' do
        allow(board).to receive(:data).and_return(data)
        result = bbp.find_possible_moves(board)
  ...
  describe '#find_possible_captures' do
    ...
    context 'when there are 1 opposing piece to capture decreasing rank' do
      subject(:wbp) { described_class.new(board, { color: :white, location: [7, 2] }) }
      let(:data) do
        [
          [nil, nil, nil, nil, nil, nil, nil, nil],
          [nil, nil, nil, nil, nil, nil, nil, nil],
    ...
    context 'when there are 2 opposing pieces to capture increasing rank' do
      subject(:bbp) { described_class.new(board, { color: :black, location: [1, 3] }) }
      let(:data) do
        [
          [nil, nil, nil, nil, nil, nil, nil, nil],
          [nil, nil, nil, bbp, nil, nil, nil, nil],
          [nil, nil, nil, nil, nil, nil, nil, nil],
          [nil, nil, nil, nil, nil, wpc, nil, nil],
      ...
      it 'has two captures' do
        allow(board).to receive(:data).and_return(data)
        result = bbp.find_possible_captures(board)
